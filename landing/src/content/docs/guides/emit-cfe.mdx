...
| `CrearNotaCreditoEFacturaExportacion()` | NC e-Factura de Exportación | 122 |
| `CrearNotaDebitoEFacturaExportacion()` | ND e-Factura de Exportación | 123 |
| `CrearERemitoDespachante()` | e-Remito Despachante | 131 |
| `CrearEResguardo()` | e-Resguardo | 151 |
| `CrearERemito()` | e-Remito | 181 |
| `CrearNotaCreditoERemito()` | Nota de Crédito e-Remito | 182 |
...
| `TipoIva.Suspendido` | — | IVA suspendido por disposición legal (sin cálculo, genera `MntSuspenso` en el XML) |
