...
El paquete está disponible en **[NuGet Gallery → UruFacturaSDK](https://www.nuget.org/packages/UruFacturaSDK/)**.
...
<Aside type="tip">
  Para fijar una versión específica en producción, reemplazá `*` por el número de versión que encontrás en la [página de NuGet](https://www.nuget.org/packages/UruFacturaSDK/), por ejemplo `Version="1.0.0"`.
</Aside>
