...
El paquete está publicado en **[NuGet Gallery → UruFacturaSDK](https://www.nuget.org/packages/UruFacturaSDK/)**.
...
<CardGrid>
  ...
  />
  <LinkCard
    title="📦 Paquete en NuGet"
    description="Versiones publicadas, dependencias y estadísticas de descarga."
