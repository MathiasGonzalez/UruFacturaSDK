...
hero:
  ...
  actions:
    - text: Comenzar ahora
      ...
      icon: right-arrow
      variant: primary
    - text: UruFactura en NuGet
      link: https://www.nuget.org/packages/UruFactura/
      icon: external
      variant: secondary
    - text: UruFactura.Lite en NuGet
      link: https://www.nuget.org/packages/UruFactura.Lite/
      icon: external
      variant: secondary
    - text: Ver en GitHub
      link: https://github.com/MathiasGonzalez/UruFactura
      icon: external
      variant: minimal
---
...
<Tabs>
  ...
  ```powershell
  Install-Package UruFactura
  # o Lite:
  Install-Package UruFactura.Lite
  ```
  </TabItem>
  <TabItem label="PackageReference">
  ```xml
  <PackageReference Include="UruFactura" Version="*" />
  <!-- o Lite: -->
  <PackageReference Include="UruFactura.Lite" Version="*" />
  ```
  </TabItem>
</Tabs>
