...
hero:
  ...
  actions:
    - text: Comenzar ahora
      link: /UruFacturaSDK/getting-started/installation/
      icon: right-arrow
      variant: primary
    - text: Ver en GitHub
